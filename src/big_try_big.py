...
def get_unet4():
    ...
    conv6 = Convolution2D(1024, 3, 3, border_mode='same', init='he_uniform')(pool5)
    conv6 = keras.layers.advanced_activations.PReLU(init='zero', weights=None)(conv6)
    conv6 = BatchNormalization(mode=0, axis=1)(conv6)
    conv6 = Convolution2D(1024, 3, 3, border_mode='same', init='he_uniform')(conv6)
    conv6 = keras.layers.advanced_activations.PReLU(init='zero', weights=None)(conv6)

    up7 = merge([UpSampling2D(size=(2, 2))(conv6), conv5], mode='concat', concat_axis=1)
    conv7 = Convolution2D(512, 3, 3, border_mode='same', init='he_uniform')(up7)
    conv7 = keras.layers.advanced_activations.PReLU(init='zero', weights=None)(conv7)
    conv7 = BatchNormalization(mode=0, axis=1)(conv7)
    conv7 = Convolution2D(512, 3, 3, border_mode='same', init='he_uniform')(conv7)
    conv7 = keras.layers.advanced_activations.PReLU(init='zero', weights=None)(conv7)

    up8 = merge([UpSampling2D(size=(2, 2))(conv7), conv4], mode='concat', concat_axis=1)
    conv8 = Convolution2D(256, 3, 3, border_mode='same', init='he_uniform')(up8)
    conv8 = keras.layers.advanced_activations.PReLU(init='zero', weights=None)(conv8)
    conv8 = BatchNormalization(mode=0, axis=1)(conv8)
    conv8 = Convolution2D(256, 3, 3, border_mode='same', init='he_uniform')(conv8)
    conv8 = keras.layers.advanced_activations.PReLU(init='zero', weights=None)(conv8)

    up9 = merge([UpSampling2D(size=(2, 2))(conv8), conv3], mode='concat', concat_axis=1)
    conv9 = Convolution2D(128, 3, 3, border_mode='same', init='he_uniform')(up9)
    conv9 = keras.layers.advanced_activations.PReLU(init='zero', weights=None)(conv9)
    conv9 = BatchNormalization(mode=0, axis=1)(conv9)
    conv9 = Convolution2D(128, 3, 3, border_mode='same', init='he_uniform')(conv9)
    conv9 = keras.layers.advanced_activations.PReLU(init='zero', weights=None)(conv9)

    up10 = merge([UpSampling2D(size=(2, 2))(conv9), conv2], mode='concat', concat_axis=1)
    conv10 = Convolution2D(64, 3, 3, border_mode='same', init='he_uniform')(up10)
    conv10 = keras.layers.advanced_activations.PReLU(init='zero', weights=None)(conv10)
    conv10 = BatchNormalization(mode=0, axis=1)(conv10)
    conv10 = Convolution2D(64, 3, 3, border_mode='same', init='he_uniform')(conv10)
    conv10 = keras.layers.advanced_activations.PReLU(init='zero', weights=None)(conv10)

    up11 = merge([UpSampling2D(size=(2, 2))(conv10), conv1], mode='concat', concat_axis=1)
    conv11 = Convolution2D(32, 3, 3, border_mode='same', init='he_uniform')(up11)
    conv11 = keras.layers.advanced_activations.PReLU(init='zero', weights=None)(conv11)
    conv11 = BatchNormalization(mode=0, axis=1)(conv11)
    conv11 = Convolution2D(32, 3, 3, border_mode='same', init='he_uniform')(conv11)
    conv11 = keras.layers.advanced_activations.PReLU(init='zero', weights=None)(conv11)
